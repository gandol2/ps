...
function formatOutput(data) {
  ...
  data.forEach(function (d) {
    var user = d["USER"][0] || d.USER || undefined;
    var pid = ( d.PID && d.PID[0] ) || ( d.ProcessId && d.ProcessId[0] ) || undefined;
    var cpu = d["%CPU"][0] || undefined;
    var mem = d["%MEM"][0] || undefined;
    var vsz = d["VSZ"][0] || d.VSZ || undefined;
    var rss = d["RSS"][0] || d.VSZ || undefined;
    var tty = d["TTY"][0] || d.TTY || undefined;
    var stat = d["STAT"][0] || d.STAT || undefined;
    var start = d["START"][0] || d.START || undefined;
